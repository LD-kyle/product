...
def main():
   filename_evs=['worktable/table_evpromot_announce_taxfree_merge.csv']
   filename_phevs=[]
...
#   filename_evs=['table_merge_ev_cut.csv','table_merge_ke_ev_cut.csv']
   column_max=['总质量(kg)_G','整备质量(kg)_G','额定载客(含驾驶员)(座位数)_G','整车长_G',
   ...
   for filename_ev in filename_evs:
       get_ev_cut_change(filename_ev, column_max, column_min)
   for filename_phev in filename_phevs:
       get_phev_cut_change(filename_phev, column_max, column_min)
